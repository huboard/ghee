class Ghee
  ...
  class ResourceProxy
    ...
    attr_reader :connection, :path_prefix, :options
    ...
    # path_prefix - String
    #
    def initialize(connection, path_prefix, options = nil)
      @connection, @path_prefix, @options = connection, path_prefix, options
    end
