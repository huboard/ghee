...
require 'ghee/gitlab/api/translators/issue_translator'
require 'ghee/gitlab/api/translators/labels_translator'
require 'ghee/gitlab/api/translators/milestone_translator'
